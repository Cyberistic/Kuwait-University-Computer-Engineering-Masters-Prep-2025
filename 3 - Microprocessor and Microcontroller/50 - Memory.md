...
External memory is a bit more complicated and i'm not sure what's required in the exam, so check the book yourself: [../books/3 - Microprocessor and Microcontroller/Mazidi, Muhammad Ali_McKinlay, Rolin D_Mazidi, Janice Gillispie - The 8051 Microcontroller_ A Systems Approach (2013](2013).pdf#page=395)
